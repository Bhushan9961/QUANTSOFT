...
const doha = "" + buildAssetsURL("doha.Cn1l_gKF.gif");
const szr = "" + buildAssetsURL("szr.Chgwr4IQ.jpg");
const ibn = "" + buildAssetsURL("IBNmall.DyUnrW7l.jpg");
const max = "" + buildAssetsURL("maxburgers.Cz8umEIj.jpg");
const _sfc_main = {
  name: "healing",
  components: {
    VueEasyLightbox
...
export { internationalprojects as default };
//# sourceMappingURL=internationalprojects-DKfj3tv7.mjs.map
