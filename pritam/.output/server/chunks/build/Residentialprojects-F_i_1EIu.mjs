...
const aspiria = "" + buildAssetsURL("aspiria.CbhkzHK2.jpg");
const centrum = "" + buildAssetsURL("centrum-park.COVb5YNc.jpg");
const dlf = "" + buildAssetsURL("dlf.CGTwV1mr.jpg");
const eden = "" + buildAssetsURL("eden-park-2.BoAQNyjn.jpg");
const enigma = "" + buildAssetsURL("enigma.D1e47WRw.jpg");
const godrej1 = "" + buildAssetsURL("godrej-platinium.TW_1UGiv.jpg");
const indiabulls = "" + buildAssetsURL("indiabulls-greens.Dl4ImjJW.jpg");
const indiabulls2 = "" + buildAssetsURL("indiabulls-greens-panvel.ze5hF2Kq.jpg");
const m3m = "" + buildAssetsURL("m3m.l59UxQpR.jpg");
const minerva = "" + buildAssetsURL("minerva.DxSr__AB.jpg");
const sks = "" + buildAssetsURL("planet-sks.DATjDh7r.jpg");
const regent = "" + buildAssetsURL("regent-tower.DuvIRbnI.jpg");
const selene = "" + buildAssetsURL("selene-park.BCWcRsHu.jpg");
const sie = "" + buildAssetsURL("sierra.DFUNj6Uw.jpg");
const water = "" + buildAssetsURL("water-ridge.CHS78wiT.jpg");
const wave = "" + buildAssetsURL("wave-city.DwnlYt4R.jpg");
const wind = "" + buildAssetsURL("whistling-winds.Bj6wptHe.jpg");
const _sfc_main = {
  name: "healing",
  components: {
    VueEasyLightbox
...
export { Residentialprojects as default };
//# sourceMappingURL=Residentialprojects-F_i_1EIu.mjs.map
