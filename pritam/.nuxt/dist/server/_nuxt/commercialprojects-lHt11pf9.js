...
import "klona";
import "devalue";
const Ahuja = "" + __buildAssetsURL("Ahuja.CwHy6Jr4.jpg");
const Mantri = "" + __buildAssetsURL("mantri.C19hlQqi.jpg");
const IDBU = "" + __buildAssetsURL("indiabullsfinancecenter.qVFZLnUR.jpg");
const megamalljdpr = "" + __buildAssetsURL("megamalljodpur.Mcjz_ROn.jpeg");
const megamallkta = "" + __buildAssetsURL("megamallkota.B-T6kF4G.jpg");
const ongc = "" + __buildAssetsURL("ongcglobalkolkatta.blHLIkjs.jpeg");
const supreme = "" + __buildAssetsURL("supremeparkmumbai.CuLxAJCq.png");
const ambernath = "" + __buildAssetsURL("img8.CZ_KBYjG.jpg");
const bihar = "" + __buildAssetsURL("img9.3oc3RPSR.jpg");
const daund = "" + __buildAssetsURL("Daundsugar.DWXePuI_.jpg");
const _sfc_main = {
  name: "healing",
  components: {
    VueEasyLightbox
...
export {
  commercialprojects as default
};
//# sourceMappingURL=commercialprojects-lHt11pf9.js.map
